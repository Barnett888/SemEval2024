...
Original file is located at
    https://colab.research.google.com/drive/1ITBToh10L8sfa5bLthfYauDbhFKMomK_
"""
...
nb_classifier.fit(train_tfidf, training_label)

"""Predict on the test data, this step may take up to half an hour."""

predict_label = nb_classifier.predict(test_tfidf)
...
with open("/content/drive/MyDrive/ipynb/nlp_a2/nb_label.jsonl", 'w', encoding='utf-8') as f:
...
with open("/content/drive/MyDrive/ipynb/nlp_a2/nb_label.jsonl", 'r', encoding='utf-8') as f:
    result=(f.read())
result=[result]
...
predictions_df.to_json("/content/drive/MyDrive/ipynb/nlp_a2/nb.jsonl", lines=True, orient='records')

with open("/content/drive/MyDrive/ipynb/nlp_a2/nb.jsonl", 'r', encoding='utf-8') as f:
    result=(f.read())
