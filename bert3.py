...
Original file is located at
    https://colab.research.google.com/drive/16efmL7j2G6d8xSxGUcmCJC3ga3erM6kx
"""
...
model.save_pretrained("/content/drive/MyDrive/ipynb/nlp_a2/bert_model")
...
pre=preds.tolist()
with open("/content/drive/MyDrive/ipynb/nlp_a2/bert_label.jsonl", 'w', encoding='utf-8') as f:
...
with open("/content/drive/MyDrive/ipynb/nlp_a2/bert.jsonl", 'r', encoding='utf-8') as f:
    result=(f.read())
result=[result]
...
predictions_df.to_json("/content/drive/MyDrive/ipynb/nlp_a2/bert_output.jsonl", lines=True, orient='records')