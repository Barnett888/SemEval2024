...
Original file is located at
    https://colab.research.google.com/drive/1nr19SB0Vh-EBztSOUqKBhlT3ILA4srds
"""
...
svm_classifier = SVC(kernel='rbf')# gaussian is not availabe. Tried rbf and linear
svm_classifier.fit(train_tfidf, training_label)

"""Predict on the test data, this step may take up to half an hour."""

predict_label = svm_classifier.predict(test_tfidf)
...
with open("/content/drive/MyDrive/ipynb/nlp_a2/gaussian_label.jsonl", 'w', encoding='utf-8') as f:
...
with open("/content/drive/MyDrive/ipynb/nlp_a2/gaussian_label.jsonl", 'r', encoding='utf-8') as f:
    result=(f.read())
result=[result]
...
predictions_df.to_json("/content/drive/MyDrive/ipynb/nlp_a2/gassian.jsonl", lines=True, orient='records')

with open("/content/drive/MyDrive/ipynb/nlp_a2/gassian.jsonl", 'r', encoding='utf-8') as f:
    result=(f.read())
